...
@section('title', 'Statistik Konfirmasi Obat')
...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">Statistik Konfirmasi Obat</h1>
        <p class="mt-1 text-sm text-gray-600">Laporan kepatuhan minum obat pasien</p>
    </div>
